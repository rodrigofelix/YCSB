 ...
 */
public class CassandraClient10Original extends DB
{
  ...
  public int read(String table, String key, Set<String> fields, HashMap<String, ByteIterator> result)
  {
    if (!_table.equals(table)) {
      ...
      {
          System.out.println("Exception on Set Keyspace: " + Thread.currentThread().getId());
        e.printStackTrace();
      ...
      Vector<HashMap<String, ByteIterator>> result)
  {
    if (!_table.equals(table)) {
      ...
      {
          System.out.println("Entrei no set do scan: " + Thread.currentThread().getId());
        e.printStackTrace();
        //e.printStackTrace(System.out);
        return Error;
      }
