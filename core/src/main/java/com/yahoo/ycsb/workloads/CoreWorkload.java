 ...
 * runtime.
 *
 * Properties to control the client: <UL> <LI><b>fieldcount</b>: the number of
 * fields in a record (default: 10) <LI><b>fieldlength</b>: the size of each
 * field (default: 100) <LI><b>readallfields</b>: should reads read all fields
 * (true) or just one (false) (default: true) <LI><b>writeallfields</b>: should
 * updates and read/modify/writes update all fields (true) or just one (false)
 * (default: false) <LI><b>readproportion</b>: what proportion of operations
 * should be reads (default: 0.95) <LI><b>updateproportion</b>: what proportion
 * of operations should be updates (default: 0.05) <LI><b>insertproportion</b>:
 ...
 * (default: 0) <LI><b>readmodifywriteproportion</b>: what proportion of
 * operations should be read a record, modify it, write it back (default: 0)
 ...
 * uniform) <LI><b>maxscanlength</b>: for scans, what is the maximum number of
 * records to scan (default: 1000) <LI><b>scanlengthdistribution</b>: for scans,
 * what distribution should be used to choose the number of records to scan, for
 * each scan, between 1 and maxscanlength (default: uniform)
 * <LI><b>insertorder</b>: should records be inserted in order by key
 * ("ordered"), or in hashed order ("hashed") (default: hashed) </ul>
 */
