 ...
 *
 * <br> Each client will have its own instance of this class. This client is not
 * thread safe.
 *
 * <br> This interface expects a schema <key> <field1> <field2> <field3> ... All
 ...
 *
 * <ul> <li><b>db.driver</b> The JDBC driver class to use.</li>
 * <li><b>db.url</b> The Database connection URL.</li> <li><b>db.user</b> User
 * name for the connection.</li> <li><b>db.passwd</b> Password for the
 * connection.</li> </ul>
 *
 * @author sudipto
 *
